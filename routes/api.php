...
Route::middleware(['auth:sanctum', 'family_subscription'])->group(function () {
    Route::get('/me', [AuthController::class, 'me']);
    Route::post('/logout', [AuthController::class, 'logout']);

    Route::post('/push/unsubscribe', [PushController::class, 'unsubscribe']);

    Route::middleware('role:'.(\App\Models\User::ROLE_FAMILY_HEAD))->group(function () {
    ...
    Route::middleware(['role:'.(\App\Models\User::ROLE_FAMILY_HEAD), 'family_no_grace'])->group(function () {
    ...
    Route::middleware('family_no_grace')->group(function () {
    ...
    Route::middleware('role:'.(\App\Models\User::ROLE_ADMIN))->group(function () {
        ...
        Route::apiResource('admin/users', \App\Http\Controllers\Api\AdminUserController::class)->only(['index', 'store', 'destroy']);
